  ...
  return (
    ...
    relative">
      ...
      className='absolute -z-[100] opacity-50 -top-[200px]'>
        ...
        <g id="Desktop" stroke="#fff9e2" stroke-width="1" fill="none" fill-rule="evenodd" stroke-linecap="round">
          <g id="Public-Policy" transform="translate(-239.000000, -144.000000)" stroke="#fff9e2" stroke-width="60">
            <g id="Our-Impact">
              <g id="Group-13">
