      ...
      <div className="flex justify-between items-start gap-x-12">
        {whyWeMatter.map((item, index) => (
          ...
          className="flex flex-col justify-start items-start gap-y-2 z-20">
            <h3 className="text-4xl text-primary font-accent uppercase bg-offwhite p-2">{item.number}</h3>
            <p className="text-xl uppercase font-bold text-header">{item.caption}</p>
